...
label aqua:
    ...
    a"They're cute aren't they?.."
    m"Yeah."
    "He nod,{w=.25} looking back at the show in front of him while slowly treading deeper through the tank."
    a"Wahh wait for me!"
    ...
    m "hmm. :)"
    "They entered the first display room," 
    "Adeline looked up as if she was hypnotized by the fish before lightly jogging closer to the tank in order to read the plaque that accompanied it."
    a "The mola mola fish… "
    "Malcolm moved towards her, standing slightly behind her."
    a"He looks like he’d be in Roncario 64,{w=.25} hehe"
    "She grabbed Malcolm’s hand, pulling him closer; his eyes soften."
    m "Um..Did you know that they can weight over 2000 kilograms but there skeletons are mostly Cartilage."
    a "Uwahhhh really??"
    a "You’re so smart Malcolm!"
    a "I bet it would make good mola mola stock."
    m "Yum."
    ...
    "Malcolm takes a deep sigh, before joining her." 
    ...
    "She wasn't even trying to impress him; she barely looked at him the whole time she was playing with the mantises."
    "She’s genuinely just like this, cute, gentle, open."
    ...
    a "They're stupidly beautiful and effortlessly free.."
    ...
    a "But..."
    "They kinda just glide, aimlessly through space.."
    "It’s kind of inspiring.."
    "He nodded, and slightly shuffled closer to her."
    ...
    "His eyes soften at the jest, before mirroring her actions."
    ...
    "His voice lowered, that apathetic tone Adeline quickly gained accustomed too had essentially dissipated."
    ...
    "Instinctively, he slightly freeze."
    a "It doesn’t."
    "She was gentle."
    a "Not at all.."
    a "..."
    ...
    "Their eyes met, soften by the moment and a state of solidarity."
    "She smiled a little, genuine and warm."
    a "I was kind of hoping you were too."
    m "Adeline.."
    ...
    "She giggled again, single handily melting any tension that grew between them."
    ...
    "They both hopped back on their feet, getting ready to go to the gift shop."
    ...
    "Cups, Stationary, Flimsy tote bags, 95% polyester hoodies."
    "Buckets also littered the floors of plushies of a various amount of fish."
    a "Uwahhh, Look at him!"
    "Malcolm's watched her in front the small stuffed shark that was being pushed into his face."
    a "Isn’t he so cute??"
    ...
    #close cg almost kiss
    m "Rawr."
    a "AH!"
    a "Hehe ;3"
    "She fake screamed, giggling heavily as she grabbed his wrist instinctively."
    "It lingered there, much longer than she realistically needed too."
    ...
    "Her hand still remained on his wrist, her thumb slowly rubbing shaped against his pulse."
    ...
    c "Sea Life aquarium once again asks you to not take flash photography in the exhibits."
    ...
    m "Thank you."
    hide m_smile_o
    show show m_smile_c at mjump(-1)
